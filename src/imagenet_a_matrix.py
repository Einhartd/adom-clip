...
# --- NOWE IMPORTY DO MACIERZY POMYŁEK ---
import numpy as np
...
print("Przykładowe etykiety bez kontekstu:", prompts_raw[:5])
...
print("="*40)
print(f"Skuteczność (Brak kontekstu):       {acc_raw:.2f}%")
print(f"Skuteczność (Inżynieria kontekstu): {acc_eng:.2f}%")
print("="*40)

print("\nGenerowanie macierzy pomyłek dla ImageNet-A...")
...
plt.title("Macierz pomyłek CLIP ('This is an example of a...') na ImageNet-A")
